...
<html>
    ...
    <body>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 w-11/12 md:w-1/3">
            ...
            <form id="Update" action="update.jsp" method="post">
                <input type="hidden" name="id" value="<%= retrieveId%>"/>
                ...
                <div class="status mt-2">
                    <input type="text" id="status" name="status" class="w-[20.5rem] p-2 border rounded-md" placeholder="status: available - sold out" value="<%= bike.getStatus()%>">
                </div>
